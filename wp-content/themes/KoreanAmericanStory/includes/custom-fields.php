						...
						<div class="form-field form-required">
							...
							switch ( $customField[ 'type' ] ) {
								...
								case "selectbox-animation": {
									...
									if (isset($qode_options_infographer['page_transitions'])) $page_transitions = $qode_options_infographer['page_transitions'];
								...
								case "image-title-image": {
									...
									echo '<div class="image_holder"><input type="text" id="title_image" name="' . $this->prefix . $customField[ 'name' ] . '" class="title_image" value="'.htmlspecialchars( get_post_meta( $post->ID, $this->prefix . $customField[ 'name' ], true ) ).'" /><input class="upload_button" type="button" value="Upload file">';
								...
								case "colorpicker":{
									...
									echo '<input name="' . $this->prefix . $customField[ 'name' ] . '" type="text" value="' . htmlspecialchars( get_post_meta( $post->ID, $this->prefix . $customField[ 'name' ], true ) ) . '" size="30" maxlength="10" style="width: 100px !important;" />';
