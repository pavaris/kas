		...
		if($type == "" || $type == "large"){
			...
			while($q->have_posts()) : $q->the_post();
				...
				if($text_length > 0){
					...
					$html .= '"><div class="latest_post_content"><a href="'. get_permalink() .'">' . get_the_post_thumbnail(get_the_id(),'latest_posts') . '</a><h4><a href="' . get_permalink() . '">' . get_the_title() . '</a></h4></div></div>';
				}
