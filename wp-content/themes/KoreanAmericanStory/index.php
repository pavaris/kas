...
?>
	...
	<?php }else{ ?>
		...
		<div class="no_title_gap" style="<?php if($background_color != "") { echo "background-color:". $background_color ."'";} ?> <?php if(($sidebar == "default")||($sidebar == "")) { switch ($qode_options_infographer['blog_style']) { case 1: echo "height:0px;"; break; case 2: echo "height:0px;"; break; }} ?>">&nbsp;</div>
