...
#wpcufpn_widget_<?php echo $_GET['id']; ?> .wpcufpn_listposts {
    ...
    <?php if ($_GET['defaultColorTheme'] == 'no') : ?>
        background-color: <?php echo $_GET['colorfull'] ;?>
    <?php endif; ?>
}
#wpcufpn_widget_<?php echo $_GET['id']; ?> .wpcufpn_listposts .portfolio .insideframe{
    margin-right: -1px;
}
#wpcufpn_widget_<?php echo $_GET['id']; ?> .wpcufpn_listposts .portfolio a,
#wpcufpn_widget_<?php echo $_GET['id']; ?> .wpcufpn_listposts .portfolio img
{
    border: 0;
}
#wpcufpn_widget_<?php echo $_GET['id']; ?> {
	overflow: hidden;
    width: 100%;
}
#portfolioContainer_<?php echo $_GET['id']; ?> {
...
#wpcufpn_widget_<?php echo $_GET['id']; ?> .img_cropper.img-loaded {
...
#wpcufpn_widget_<?php echo $_GET['id']; ?> .portfolio .wpcu-front-box.bottom .category {
	display: block;
	text-align: left;
	font-weight: 500;
	color: #999;
...
#wpcufpn_widget_<?php echo $_GET['id']; ?> .portfolio .wpcu-front-box.bottom .category::before {
	display: block;
	position: relative;
	height: 2px;
	width: 30%;
...
#wpcufpn_widget_<?php echo $_GET['id']; ?> .wpcufpn_listposts li {
    margin-left: <?php echo ($width1/10);?>%;
    margin-top: <?php echo ($width1/20);?>%;
    margin-bottom: <?php echo ($width1/20);?>%;
