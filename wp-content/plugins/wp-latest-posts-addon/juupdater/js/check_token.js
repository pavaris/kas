(function ($) {
    ...
    JuupdatePlugin = function (plugin, slug) {
        if (slug == 'wp-media-folder' || slug == 'wp-file-download' || slug == 'wp-team-display' || slug == 'wp-table-manager' || slug == 'wp-frontpage-news-pro-addon') {
            if (token && token != '') {
    ...
    $(document).ready(function () {
        var ju_plugins = ['wp-media-folder','wp-file-download','wp-team-display','wp-table-manager','wp-frontpage-news-pro-addon'];
