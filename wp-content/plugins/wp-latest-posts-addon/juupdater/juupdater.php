...
class Ju_Updater {
	...
	protected function installHooks(){
        ...
        public function joom_connect(){
            ...
            if(empty($token)){
                ...
                $link = JU_BASE."index.php?option=com_juupdater&view=login&tmpl=component&extension=wp-media-folder.zip&site=".WP_CONTENT_URL."&TB_iframe=true&width=600&height=550";
	...
	<script type="text/javascript">
            ...
            ju_content_url = '<?php echo WP_CONTENT_URL; ?>';
	</script>
		...
		if ( $isRelevant && current_user_can('update_plugins') ) {
			...
			if ( !empty($linkText) ) {
				$pluginMeta[] = sprintf('<a href="%s">%s</a>', esc_attr($linkUrl), $linkText);
                        ...
                        $link = JU_BASE."index.php?option=com_juupdater&view=login&tmpl=component&extension=".$this->slug.".zip&site=".WP_CONTENT_URL."&TB_iframe=true&width=300&height=305";
